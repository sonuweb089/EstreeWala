...
const AboutUsSection = () => {
  ...
  return (
    <div className=" px-4 md:px-8 bg-gradient-to-b from-[#F5F0E8] to-[#C9B9A5]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          <motion.div
            className="relative overflow-hidden rounded-2xl shadow-xl w-full md:w-1/2 h-[450px]"
          ...
          {/* Image Block 2 */}
          <motion.div
            className="relative overflow-hidden rounded-2xl shadow-xl w-full md:w-1/2 h-[450px] mt-6 md:mt-12"
            variants={childTextVariants} 
          >
            <img
              src={Ab1}
        ...
        >
          ...
          <motion.p
            className="text-black font-semibold tracking-wider uppercase mb-3"
            variants={childTextVariants}
          >
            About Us
          </motion.p>
          ...
          <motion.button
            className="bg-[#2E2A53] text-white text-lg font-semibold py-3 px-8 rounded-lg shadow-md hover:bg-[#2E2A20] transition-colors duration-300"
            variants={childTextVariants}
          >
            Order now
          </motion.button>
